...
char plc_program_md5[] = "beac0bf9ec9e62cc146ac60714fd8b94";
...
static const struct {
    ...
    {&(RES0__INSTANCE0.STOPPED_LED), BOOL_ENUM},
    {&(RES0__INSTANCE0.RUNNING_LED), BOOL_ENUM},
    {&(RES0__INSTANCE0.MANUAL_LED), BOOL_ENUM},
    ...
    {&(RES0__INSTANCE0.SET_MANUAL), BOOL_ENUM},
