...
void MAIN_init__(MAIN *data__, BOOL retain) {
  ...
  __INIT_VAR(data__->SET_MANUAL,__BOOL_LITERAL(FALSE),retain)
...
void MAIN_body__(MAIN *data__) {
  ...
  __SET_VAR(data__->,STOPPED_LED,,__GET_VAR(data__->STATE_DISPLAY1.STOPPED_LED,));
  __SET_VAR(data__->,RUNNING_LED,,__GET_VAR(data__->STATE_DISPLAY1.RUNNING_LED,));
  __SET_VAR(data__->,MANUAL_LED,,__GET_VAR(data__->STATE_DISPLAY1.MANUAL_LED,));
