...
char plc_program_md5[] = "de9a72e233c0e1c8aed78f32f8a3c85a";
...
static const struct {
    ...
    {&(RES0__INSTANCE0.TIMER_PAUSE.EN), BOOL_ENUM},
    {&(RES0__INSTANCE0.TIMER_PAUSE.ENO), BOOL_ENUM},
    {&(RES0__INSTANCE0.TIMER_PAUSE.IN), BOOL_ENUM},
    {&(RES0__INSTANCE0.TIMER_PAUSE.PT), TIME_ENUM},
    {&(RES0__INSTANCE0.TIMER_PAUSE.Q), BOOL_ENUM},
    {&(RES0__INSTANCE0.TIMER_PAUSE.ET), TIME_ENUM},
    {&(RES0__INSTANCE0.TIMER_PAUSE.STATE), SINT_ENUM},
    {&(RES0__INSTANCE0.TIMER_PAUSE.PREV_IN), BOOL_ENUM},
    {&(RES0__INSTANCE0.TIMER_PAUSE.CURRENT_TIME), TIME_ENUM},
    {&(RES0__INSTANCE0.TIMER_PAUSE.START_TIME), TIME_ENUM},
    {&(RES0__INSTANCE0.TIMER_LYS.EN), BOOL_ENUM},
    {&(RES0__INSTANCE0.TIMER_LYS.ENO), BOOL_ENUM},
    {&(RES0__INSTANCE0.TIMER_LYS.IN), BOOL_ENUM},
    {&(RES0__INSTANCE0.TIMER_LYS.PT), TIME_ENUM},
    {&(RES0__INSTANCE0.TIMER_LYS.Q), BOOL_ENUM},
    {&(RES0__INSTANCE0.TIMER_LYS.ET), TIME_ENUM},
    {&(RES0__INSTANCE0.TIMER_LYS.STATE), SINT_ENUM},
    {&(RES0__INSTANCE0.TIMER_LYS.PREV_IN), BOOL_ENUM},
    {&(RES0__INSTANCE0.TIMER_LYS.CURRENT_TIME), TIME_ENUM},
    {&(RES0__INSTANCE0.TIMER_LYS.START_TIME), TIME_ENUM},
    {&(RES0__INSTANCE0.TIMERLYSON), BOOL_ENUM},
    {&(RES0__INSTANCE0.PRESETTIME), TIME_ENUM},
    {&(RES0__INSTANCE0.PRESETTIME1), TIME_ENUM},
    {&(RES0__INSTANCE0.REDLED), BOOL_ENUM},
};
