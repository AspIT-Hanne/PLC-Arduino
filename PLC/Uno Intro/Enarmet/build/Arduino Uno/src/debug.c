...
char plc_program_md5[] = "348c5aee1e9af445ea5e96bdf3df2d0d";
...
static const struct {
    ...
    {&(RES0__INSTANCE0.SEG1_DISPLAY.EN), BOOL_ENUM},
    {&(RES0__INSTANCE0.SEG1_DISPLAY.ENO), BOOL_ENUM},
    {&(RES0__INSTANCE0.SEG1_DISPLAY.INPUTTAL), INT_ENUM},
    {&(RES0__INSTANCE0.SEG1_DISPLAY.A), BOOL_ENUM},
    {&(RES0__INSTANCE0.SEG1_DISPLAY.B), BOOL_ENUM},
    {&(RES0__INSTANCE0.SEG1_DISPLAY.C), BOOL_ENUM},
    {&(RES0__INSTANCE0.SEG1_DISPLAY.D), BOOL_ENUM},
    {&(RES0__INSTANCE0.SEG1_DISPLAY.E), BOOL_ENUM},
    {&(RES0__INSTANCE0.SEG1_DISPLAY.F), BOOL_ENUM},
    {&(RES0__INSTANCE0.SEG1_DISPLAY.G), BOOL_ENUM},
    {&(RES0__INSTANCE0.RESETVALUE), INT_ENUM},
    {&(RES0__INSTANCE0.PRESETVALUE), INT_ENUM},
    {&(RES0__INSTANCE0.RESETTRIGGER), BOOL_ENUM},
    ...
    {&(RES0__INSTANCE0.TON_TIMER), TIME_ENUM},
    {&(RES0__INSTANCE0.TON_TRIGGER), BOOL_ENUM},
    {&(RES0__INSTANCE0.SEG1_TRIGGER), BOOL_ENUM},
    {&(RES0__INSTANCE0.SEG_A), BOOL_O_ENUM},
    {&(RES0__INSTANCE0.SEG_B), BOOL_O_ENUM},
    {&(RES0__INSTANCE0.SEG_C), BOOL_O_ENUM},
    {&(RES0__INSTANCE0.SEG_D), BOOL_O_ENUM},
    {&(RES0__INSTANCE0.SEG_E), BOOL_O_ENUM},
    {&(RES0__INSTANCE0.SEG_F), BOOL_O_ENUM},
    {&(RES0__INSTANCE0.SEG_G), BOOL_O_ENUM},
    {&(RES0__INSTANCE0.BTNGREEN), BOOL_P_ENUM},
};
